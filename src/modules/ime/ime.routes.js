...
router.get('/reports/soa', imeController.soaReport);

/**
 * Phase 2 eKYC Endpoints (REST-based)
 */
router.post('/ekyc/generate-ott', imeController.generateOTT);
router.post('/ekyc/get-unique-id', imeController.getUniqueId);
router.post('/ekyc/bio-kyc', imeController.bioKyc);
router.post('/ekyc/customer-onboarding', imeController.customerOnboarding);
router.post('/ekyc/customer-requery', imeController.customerRequeryEKyc);
router.post('/ekyc/check-entity-status', imeController.checkEntityStatus);
router.post('/ekyc/aadhar-registration', imeController.aadharCustomerRegistration);
router.post('/ekyc/aadhar-reprocess', imeController.aadharEntityReprocess);
