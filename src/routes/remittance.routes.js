...
const { checkRestriction } = require('../middleware/restriction.middleware');
const router = express.Router();

// Prabhu Transaction endpoints
router.post('/SendPrabhuTransaction', authMiddleware, checkRestriction('PRABHU_REMITTANCE'), remittanceController.sendPrabhuTransaction);
